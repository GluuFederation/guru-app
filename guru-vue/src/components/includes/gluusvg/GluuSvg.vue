<template>
  <div v-if="icon === 'installation'">
    <svg xmlns="http://www.w3.org/2000/svg" width="59.96" height="41.54" viewBox="0 0 59.96 41.54">
      <g transform="translate(0.01 -0.23)">
        <path
          d="M53.7,41.04H5.76A5.767,5.767,0,0,1,0,35.28V32.46a1.484,1.484,0,0,1,1.5-1.5H4.32V3.9A3.893,3.893,0,0,1,8.22,0h42.9a4.05,4.05,0,0,1,4.02,3.78V30.96h2.82a1.484,1.484,0,0,1,1.5,1.5v2.82A5.767,5.767,0,0,1,53.7,41.04ZM3,33.96v1.32a2.8,2.8,0,0,0,2.76,2.76h48a2.8,2.8,0,0,0,2.76-2.76V33.96H53.7a1.484,1.484,0,0,1-1.5-1.5V4.02A1.142,1.142,0,0,0,51.18,3H8.22a.924.924,0,0,0-.9.9V32.46a1.483,1.483,0,0,1-1.5,1.5ZM33.54,35.7H25.98a3.1,3.1,0,0,1-2.76-1.741H10.62a1.52,1.52,0,0,1-1.5-1.5,1.484,1.484,0,0,1,1.5-1.5h13.8a1.484,1.484,0,0,1,1.5,1.5V32.7h7.62V32.46a1.484,1.484,0,0,1,1.5-1.5H48.9a1.5,1.5,0,1,1,0,3H36.3A3.017,3.017,0,0,1,33.54,35.7ZM27.18,23.52A1.449,1.449,0,0,1,26.1,23.1L22.44,19.38a1.364,1.364,0,0,1-.449-.989,1.525,1.525,0,0,1,.449-1.111,1.362,1.362,0,0,1,1.028-.45,1.51,1.51,0,0,1,1.073.45l2.64,2.64,7.86-7.74a1.363,1.363,0,0,1,1.028-.45,1.512,1.512,0,0,1,1.073.45,1.364,1.364,0,0,1,.449.989,1.526,1.526,0,0,1-.449,1.112L28.26,23.1A1.528,1.528,0,0,1,27.18,23.52Z"
  ...
  <div v-else-if="icon === 'identity-management'">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="49.962"
      height="50.394"
      viewBox="0 0 49.962 50.394"
    >
      <g transform="translate(-0.02)">
        <path
          d="M2.038.294a1,1,0,0,0-1.42,0L.294.618a1,1,0,0,0,1.42,1.42l.324-.324A1,1,0,0,0,2.038.294Z"
          transform="translate(40.089 7.776)"
        ></path>
        <path
          d="M7.376,0H1A1,1,0,0,0,1,2.008H5.169L1.7,5.478A1,1,0,0,0,3.118,6.9L6.372,3.643V7.376a1,1,0,0,0,2.008,0V1A1,1,0,0,0,7.376,0Z"
          transform="translate(41.601)"
        ></path>
        <path
          d="M48.958,50.394H42.585a1,1,0,0,1,0-2.008H46.75L38.36,40A19.922,19.922,0,0,1,11.6,40L3.211,48.386H7.376a1,1,0,0,1,0,2.008H1a1,1,0,0,1-1-1V43.017a1,1,0,0,1,2.008,0V46.75l8.175-8.176a19.921,19.921,0,0,1,0-26.756L2.008,3.643V7.376A1,1,0,0,1,0,7.376V1A1,1,0,0,1,1,0H7.376a1,1,0,0,1,0,2.008H3.211L11.6,10.4A19.948,19.948,0,0,1,39.779,38.575l8.175,8.176V43.017a1,1,0,0,1,2.008,0V49.39A1,1,0,0,1,48.958,50.394ZM24.98,7.246A17.951,17.951,0,1,0,42.932,25.2,17.971,17.971,0,0,0,24.98,7.246Z"
  ...
  <div v-else-if="icon === 'authentication'">
    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="47.667" viewBox="0 0 51 47.667">
  ...
  <div v-else-if="icon === 'customization'">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="50.523"
      height="50.525"
      viewBox="0 0 50.523 50.525"
    >
      <g transform="translate(0.276 0.276)">
        <path
          d="M.105,4.527l3.3,5.768a.823.823,0,0,0,.515.39l3.074.769L17.534,22,18.7,20.835,7.99,10.124a.822.822,0,0,0-.382-.217L4.653,9.166,1.848,4.252,4.253,1.846,9.168,4.655,9.909,7.61a.822.822,0,0,0,.217.383L20.835,18.7,22,17.539,11.456,6.993l-.769-3.073A.825.825,0,0,0,10.3,3.4L4.53.108A.824.824,0,0,0,3.541.24L.246,3.536A.824.824,0,0,0,.105,4.527Z"
          class="path-with-stroke"
          stroke-miterlimit="10"
          stroke-width="0.5"
        ></path>
        <path
          d="M20,1.208,1.208,20,0,18.792,18.792,0Z"
        ...
        ></path>
        <path
          d="M8.572,10H3.429a.868.868,0,0,1-.735-.4L.122,5.429a.812.812,0,0,1,0-.858L2.694.4A.866.866,0,0,1,3.429,0H8.572a.866.866,0,0,1,.734.4l2.571,4.167a.808.808,0,0,1,0,.858L9.306,9.6A.867.867,0,0,1,8.572,10ZM3.914,1.667,1.857,5,3.914,8.333H8.087L10.144,5,8.087,1.667Z"
        ...
        ></path>
        <path
          d="M43.277,50A6.675,6.675,0,0,1,38.5,48.01l-9.937-9.937a.832.832,0,0,1,0-1.177l.417-.417a.934.934,0,0,0-1.321-1.321l-.417.417a.833.833,0,0,1-1.178,0l-1.91-1.91-4.367,4.367A9.99,9.99,0,1,1,10,29.988a9.8,9.8,0,0,1,1.951.2L30.19,11.948A9.957,9.957,0,0,1,42.4.307a.833.833,0,0,1,.391,1.4L37.6,6.891,38.976,11l4.114,1.371,5.185-5.181a.833.833,0,0,1,1.4.388,9.962,9.962,0,0,1-9.656,12.411h-.033a9.86,9.86,0,0,1-1.951-.2l-4.367,4.367,1.91,1.91a.835.835,0,0,1,0,1.178l-.417.417a.934.934,0,0,0,1.321,1.321l.417-.417a.832.832,0,0,1,1.177,0L48.01,38.5l.042.043A6.722,6.722,0,0,1,43.277,50ZM9.94,31.654a8.385,8.385,0,1,0,8.127,6.316.837.837,0,0,1,.22-.791l18.9-18.892h0a.829.829,0,0,1,.589-.244.837.837,0,0,1,.2.025,8.288,8.288,0,0,0,2.056.259h.042A8.288,8.288,0,0,0,48.313,10c0-.153-.005-.308-.015-.473L43.9,13.918a.832.832,0,0,1-.852.2l-5-1.666a.832.832,0,0,1-.527-.526l-1.666-5a.836.836,0,0,1,.2-.851l4.394-4.4c-.163-.01-.337-.016-.516-.016A8.288,8.288,0,0,0,31.911,12.01a.836.836,0,0,1-.219.791L12.8,31.694a.843.843,0,0,1-.792.22A8.39,8.39,0,0,0,9.94,31.654Zm38.05,9.83h0L41.484,47.99a5.045,5.045,0,0,0,1.772.323h.007a5.056,5.056,0,0,0,4.727-6.829ZM28.332,33.206a2.6,2.6,0,0,1,1.993,4.27l9.355,9.355c.092.092.2.186.318.288L47.12,40c-.1-.12-.2-.227-.289-.318l-9.347-9.355a2.6,2.6,0,0,1-3.665-3.66l-1.333-1.329-7.16,7.149,1.333,1.332A2.6,2.6,0,0,1,28.332,33.206Z"
          class="path-with-stroke"
          stroke-miterlimit="10"
          stroke-width="0.5"
        ></path>
        <path
          d="M9,7.885,7.885,9,0,1.115,1.115,0Z"
  ...
  <div v-else-if="icon === 'access-management'">
  ...
  <div v-else-if="icon === 'maintenance'">
    <svg xmlns="http://www.w3.org/2000/svg" width="50.5" height="42.5" viewBox="0 0 50.5 42.5">
      <g transform="translate(0.25 0.25)">
        <path
  ...
  <div v-else-if="icon === 'feature-request'">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="50.085"
      height="51.59"
  ...
  <div v-else-if="icon === 'logout'">
    <svg
      ...
      width="49.999"
      height="53.334"
      viewBox="0 0 49.999 53.334"
    >
      <path
        d="M17.182,53.334a1.552,1.552,0,0,1-.8-.224L.759,43.735A1.57,1.57,0,0,1,0,42.4V1.562A1.567,1.567,0,0,1,1.543,0H32.811a1.565,1.565,0,0,1,1.563,1.562V18.854H37.5V17.292a1.563,1.563,0,0,1,2.429-1.3l9.374,6.25a1.563,1.563,0,0,1,0,2.6l-9.374,6.25a1.562,1.562,0,0,1-2.429-1.3V28.229H34.375V42.4a1.564,1.564,0,0,1-1.563,1.562H18.75V51.77A1.568,1.568,0,0,1,17.182,53.334ZM3.125,4.322V41.51l12.5,7.5V11.822ZM7.2,3.125,17.991,9.6a1.57,1.57,0,0,1,.759,1.339v29.9h12.5v-12.6H23.437a1.564,1.564,0,0,1-1.562-1.562v-6.25a1.564,1.564,0,0,1,1.562-1.562h7.812V3.125ZM25,21.979V25.1H39.062a1.564,1.564,0,0,1,1.562,1.562v.205l5-3.33-5-3.331v.206a1.564,1.564,0,0,1-1.562,1.562Z"
      ></path>
    </svg>
  </div>
  <div v-else-if="icon === 'other'">
    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="43.056" viewBox="0 0 50 43.056">
