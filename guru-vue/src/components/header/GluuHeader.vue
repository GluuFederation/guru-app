	...
	<div id="nav-container">
		<b-container fluid>
			<b-navbar toggleable="lg"  variant="faded" type="light">
				<b-navbar-brand :to="{ name: 'Home' }"><b-img :src="logoSvgUrl" /></b-navbar-brand>
				...
				<b-collapse is-nav id="nav_collapse">
					...
					<b-navbar-nav>
						<b-nav-item :to="{ path: '/dashboard' }" class="nav-item-gluu">Dashboard</b-nav-item>
					...
					<b-navbar-nav class="ml-auto">
						...
						<b-nav-item>
							<b-dropdown variant="link" no-caret class="nav-dropdown-gluu">
								<template slot="button-content"><b-img :src="infoUrl" rounded="circle" /></template>
						...
						<b-nav-item>
							<b-dropdown variant="link" no-caret class="nav-dropdown-gluu">
								<template slot="button-content"><b-img :src="avatarUrl" rounded="circle"></b-img></template>
