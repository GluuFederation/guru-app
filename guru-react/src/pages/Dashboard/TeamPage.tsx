                      ...
                      <Grid container>
                        ...
                        <Grid item md={9} xs={12} sm={12}>
                          ...
                          <Typography variant="body2" align="left">
                            A team of digital product thinker
                          </Typography>
                    ...
                    <Box p={2}>
                      <Grid container>
                        <Grid item md={10} xs={8} sm={8}>
                          ...
                          <Typography variant="body2" align="left">
                            User listed belongs to your team
                          </Typography>
                        </Grid>
                        ...
                        <Grid item md={12} xs={12} sm={12}>
                          <Box textAlign="left" mb={2}>
                            ...
                            <Typography
                              ...
                              align="left"
                            >
                              You can add 2 more member(s) under your existing
                              plan.{" "}
                            </Typography>
                            <Typography
                              display="inline"
                      ...
                      <Grid container>
                        <Grid item md={12} xs={12} sm={12}>
                          <Box style={{ width: "100%", overflowX: "auto" }}>
                            <table
                              className={classes.teamMembersTb}
                              style={{ width: "100%" }}
                            >
                              <tr>
                                <th>
