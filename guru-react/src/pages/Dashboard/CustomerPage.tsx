                  ...
                  <Grid item md={8} xs={12} sm={12}>
                    <Box mt={2} mb={2}>
                      <Typography variant="body2" align="left">
                        ...
                        distracted by the readable content of the page when
                      ...
                      <Grid item xs={12}>
                        <Box>
                          ...
                          <Typography
                            ...
                            color="textPrimary"
                          >
                            The Customer will able to manage privileges for this
                            users.
                          </Typography>
                        </Box>
                      </Grid>
...
export default withStyles(styles)(withRouter(CustomerPage));
