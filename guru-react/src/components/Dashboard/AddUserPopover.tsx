          ...
          <form>
            <Box>
              ...
              <Typography variant="caption" align="left" color="textSecondary">
                Assign resources that are available to help manage this
                customer's Gluu support account.
              </Typography>
              <Typography
                variant="caption"
                align="left"
                ...
                display="block"
              >
                Customer : <span style={{ color: "#00b372" }}>Team Orizon</span>
              </Typography>
              <Select
                    ...
                    {(selected as string[]).map(value => (
                      ...
                      >
                        <Avatar
                          alt="Avatar"
                          src={UserOne}
                          className={classes.avatarXsmall}
                        />
