    ...
    return (
      <div>
        <Button
          ...
          onClick={this.handleOpenInviteMen}
        >
          Invite new
        </Button>

        <Modal
          open={this.state.openInviteMen}
          onClose={this.handleCloseInviteMen}
        >
...
export default withStyles(styles)(withRouter(InviteMemberPopover));
